...
public class City_Manager_5 : MonoBehaviour
{
    ...
    // No identity tests in sessions 4-5
    private int[] idnChoiceList1 = { 1, 1, 1, 1 }; 
    private int[] idnChoiceList2 = { 2, 2, 2, 2 };
    private int[] idnChoiceList3 = { 3, 3, 3, 3 };
    private int[] correctIDNanswers = { 0, 0, 0, 0 };
    ...
    private int[] landmarkIndex = { 2, 3, 1, 1, 2, 3, 4, 4 }; // 8 questions in session 5
    private int[] correctJRDanswers = { 2, 3, 4, 3, 2, 4, 3, 3 }; // 8 questions in session 5

    private int jrdIndex = 0;
    private int jrdTempIndex;
    private bool[] jrdQuestionDone = { false, false, false, false, false, false, false, false }; // 8 questions in session 5
    ...
    private bool navEnd;
    private string next_scene_name = "DVIM_JRD_1"; // Change this in the new version: Go to the JRD task
    ...
    private string[] moveMethods =
        new string[] { "turn", // Make observations of directions at the beginning
                       ...
                       "mXnT", "tJRD", "view", "mXnV", "mZnV", "mZnT", "view", "turn", // View facades 2A & 2B // TEST ON 2A
                       "movZ", "turn", "movX", // From facades 2A & 2B to facades 3A & 3B
                       "mXnT", "tJRD", "view", "turn", "stop", "turn", "view", "turn", // View facades 3A & 3B // TEST ON 3A
                       ...
                       "mXnT", "tJRD", "view", "turn", "stop", "turn", "tJRD", "view", "turn", // View facades 6A & 6B // TEST ON 6A & 6B
                       "movX", "turn", "movZ", // From facades 6A & 6B to facades 7A & 7B
                       "mZnT", "view", "mZnV", "mXnV", "mXnT", "tJRD", "view", "turn", // View facades 7A & 7B // TEST ON 7B
                       ...
                       "mXnT", "tJRD", "view", "mXnV", "mZnV", "mZnT", "tJRD", "view", "turn", // View facades 10A & 10B // TEST ON 10A, 10B
                       ...
                       "mZnT", "tJRD", "view", "turn", "stop", "turn", "view", "turn", // View facades 12A & 12B // TEST ON 12A
    ...
    private float[] positionX =
        new float[] { 95, 95, // direction observation
                      ...
                      57, 57, 57, 71, 71, 71, 71, 71, // view 2AB
                      71, 71, 128, // 2AB -> 3AB
                      ...
                      150, 150, 43, // 5AB -> 6AB
                      35, 35, 35, 35, 35, 35, 35, 35, 35, // view 6AB
                      24, 24, 24, // 6AB -> 7AB
    ...
    private float[] positionZ =
        new float[]  { 68, 68, // direction observation
                       ...
                       68, 68, 68, 68, 67, 59, 59, 59, // view 2AB
                       44, 44, 44, // 2AB -> 3AB
                       ...
                       99, 99, 99, // 5AB -> 6AB
                       99, 99, 99, 99, 99, 99, 99, 99, 99, // view 6AB
                       99, 99, 129, // 6AB -> 7AB
    ...
    private float[] turnDirection =
        new float[] { 360, // direction observation
                      ...
                      0, -90, 0, // 5AB -> 6AB
                      -90, 0, 0, 90, 0, 90, 0, 0, -90, // view 6AB
                      0, 90, 0, // 6AB -> 7AB
    ...
    private float[] curHeading =
        new float[] { 180, 180, // direction observation
                      ...
                      180, 180, 180, 180, 180, 270, 270, 180, // view 2AB
                      180, 90, 90, // 2AB -> 3AB
                      ...
                      0, 270, 270, // 5AB -> 6AB
                      180, 180, 180, 270, 270, 0, 0, 0, 270, // view 6AB
                      270, 0, 0, // 6AB -> 7AB
    ...
    void Update()
    {
        ...
        // {
        //    EventLogger.Instance.LogEvent("Skipped the navigation session 5," + System.DateTime.Now.ToString("yyyyMMdd, HH:mm, ss.ffff,") + "-, -, -, -");
        //    SceneManager.LoadScene(next_scene_name);
        // }
