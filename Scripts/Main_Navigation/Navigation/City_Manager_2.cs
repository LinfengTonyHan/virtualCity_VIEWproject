...
public class City_Manager_2 : MonoBehaviour
{
    ...
    private int[] idnChoiceList1 = { 1, 16, 22, 9 };
    private int[] idnChoiceList2 = { 24, 8, 5, 13 };
    private int[] idnChoiceList3 = { 4, 14, 15, 18 };
    private int[] correctIDNanswers = { 1, 2, 3, 3 };
    ...
    private bool[] idnQuestionDone = { false, false, false, false };
    ...
    private int[] landmarkIndex = { 1, 1, 1, 1 }; // No JRD tests in sessions 1-3
    private int[] correctJRDanswers = { 0, 0, 0, 0 }; // No JRD tests in sessions 1-3
    ...
    private bool navEnd;
    private string next_scene_name = "DVIM_City_Main_3"; // Change this in the new version
    ...
    private string[] moveMethods =
        new string[] { "turn", // Make observations of directions at the beginning
                       ...
                       "mZnT", "tIDN", "view", "turn", "stop", "turn", "view", "turn", // View facades 1A & 1B // TEST ON 1A
                       ...
                       "mXnT", "view", "mXnV", "mZnV", "mZnT", "tIDN", "view", "turn", // View facades 4A & 4B // TEST ON 4B
                       ...
                       "mZnT", "tIDN", "view", "mZnV", "mXnV", "mXnT", "view", "turn", // View facades 8A & 8B // TEST ON 8A
                       "movX", "turn", "movZ", "turn", "movX", // From facades 8A & 8B to facades 9A & 9B
                       "mXnT", "view", "turn", "stop", "turn", "tIDN", "view", "turn", // View facades 9A & 9B // TEST ON 9B
    ...
    private float[] positionX =
        new float[] { 95, 95, // direction observation
                      ...
                      24, 24, 24, 24, 24, 24, 24, 24, // view facades 1AB
                      ...
                      71, 71, 71, // 7AB -> 8AB
                      71, 71, 71, 71, 74, 82, 82, 82, // view 8AB
    ...
    private float[] positionZ =
        new float[]  { 68, 68, // direction observation
                       ...
                       34, 34, 34, 34, 34, 34, 34, 34, // view facades 1AB
                       ...
                       147, 147, 143, // 7AB -> 8AB
                       135, 135, 135, 123, 123, 123, 123, 123, // view 8AB
    ...
    private float[] turnDirection =
        new float[] { 360, // direction observation
                      ...
                      -90, 0, 0, 90, 0, 90, 0, -90, // view facades 1AB
    ...
    private float[] curHeading =
        new float[] { 180, 180, // direction observation
                      ...
                      270, 270, 270, 0, 0, 90, 90, 0, // view facades 1AB
                      ...
                      90, 180, 180, // 7AB -> 8AB
                      90, 90, 90, 90, 90, 0, 0, 90, // view 8AB
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Escape))
        {
            ...
            EventLogger.Instance.LogEvent("Quitted the second navigation session and accessed the main menu," + System.DateTime.Now.ToString("yyyyMMdd, HH:mm, ss.ffff,") + "-, -, -, -");
        }
        ...
        if (Input.GetKeyDown(KeyCode.N))
        {
            if (navEnd)
            {
                EventLogger.Instance.LogEvent("Finished the second navigation session," + System.DateTime.Now.ToString("yyyyMMdd, HH:mm, ss.ffff,") + "-, -, -, -");
        ...
        // {
        //    EventLogger.Instance.LogEvent("Skipped the navigation session 2," + System.DateTime.Now.ToString("yyyyMMdd, HH:mm, ss.ffff,") + "-, -, -, -");
        //    SceneManager.LoadScene(next_scene_name);
        // }
