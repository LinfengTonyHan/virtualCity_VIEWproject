...
public class City_Manager_7 : MonoBehaviour
{
    ...
    private int[] idnChoiceList1 = { 2, 6, 19, 24, 20, 23 }; // 6 questions in session 7
    private int[] idnChoiceList2 = { 3, 4, 10, 14, 5, 13 };
    private int[] idnChoiceList3 = { 17, 1, 11, 18, 22, 12 };
    private int[] correctIDNanswers = { 1, 1, 3, 2, 3, 1 };
    ...
    private bool[] idnQuestionDone = { false, false, false, false, false, false}; // 6 jrd questions in session 6
    ...
    private int[] landmarkIndex = { 1, 2, 3, 4, 2, 1 }; // 6 questions in session 6
    private int[] correctJRDanswers = { 1, 1, 1, 2, 2, 4 }; // 6 questions in session 6

    private int jrdIndex = 0;
    private int jrdTempIndex;
    private bool[] jrdQuestionDone = { false, false, false, false, false, false }; // 6 questions in session 6
    ...
    private bool navEnd;
    private string next_scene_name = "DVIM_Quit"; // Change this in the new version
    ...
    private string[] moveMethods =
        new string[] { "turn", // Make observations of directions at the beginning
                       ...
                       "mZnT", "tJRD", "view", "turn", "stop", "turn", "tIDN", "view", "turn", // View facades 1A & 1B // IDN TEST ON 1B // JRD TEST ON 1A
                       ...
                       "mXnT", "view", "turn", "stop", "turn", "tIDN", "view", "turn", // View facades 3A & 3B // IDN TEST ON 3B
                       "movX", "turn", "movZ", "turn", "movX", // From facades 3A & 3B to facades 4A & 4B
                       "mXnT", "tJRD", "view", "mXnV", "mZnV", "mZnT", "view", "turn", // View facades 4A & 4B // JRD TEST ON 4A
                       ...
                       "mXnT", "tIDN", "view", "turn", "stop", "turn", "view", "turn", // View facades 6A & 6B // IDN TEST ON 6A
                       "movX", "turn", "movZ", // From facades 6A & 6B to facades 7A & 7B
                       "mZnT", "view", "mZnV", "mXnV", "mXnT", "tIDN", "view", "turn", // View facades 7A & 7B // IDN TEST ON 7B
                       "movX", "turn", "movZ", // From facades 7A & 7B to facades 8A & 8B
                       "mZnT", "tJRD", "view", "mZnV", "mXnV", "mXnT", "tJRD", "view", "turn", // View facades 8A & 8B // JRD TEST ON 8A, 8B
                       "movX", "turn", "movZ", "turn", "movX", // From facades 8A & 8B to facades 9A & 9B
                       "mXnT", "view", "turn", "stop", "turn", "tJRD", "view", "turn", // View facades 9A & 9B // JRD TEST ON 9B
                       ...
                       "mXnT", "tJRD", "view", "mXnV", "mZnV", "mZnT", "tIDN", "view", "turn", // View facades 11A & 11B // IDN TEST ON 11B // JRD TEST ON 11A
                       "movZ", "turn", "movX", "turn", "movZ", // From facades 11A & 11B to facades 12A & 12B
                       "mZnT", "tIDN", "view", "turn", "stop", "turn", "view", "turn", // View facades 12A & 12B // IDN TEST ON 12A
    ...
    private float[] positionX =
        new float[] { 95, 95, // direction observation
                      ...
                      24, 24, 24, 24, 24, 24, 24, 24, 24, // view facades 1AB
                      24, 24, 47, 47, 47, 47, 49, // 1AB -> 2AB
                      57, 57, 71, 71, 71, 71, 71, // view 2AB
                      71, 71, 128, // 2AB -> 3AB
                      136, 136, 136, 136, 136, 136, 136, 136, // view 3AB
                      ...
                      150, 150, 43, // 5AB -> 6AB
                      35, 35, 35, 35, 35, 35, 35, 35, // view 6AB
                      24, 24, 24, // 6AB -> 7AB
                      24, 24, 24, 29, 37, 37, 37, 37, // view 7AB
                      71, 71, 71, // 7AB -> 8AB
                      71, 71, 71, 71, 74, 82, 82, 82, 82, // view 8AB
                      ...
                      162, 162, 162, 150, 150, 150, 150, 150, 150, // view 11AB
    ...
    private float[] positionZ =
        new float[]  { 68, 68, // direction observation
                       ...
                       34, 34, 34, 34, 34, 34, 34, 34, 34, // view facades 1AB
                       44, 44, 44, 44, 68, 68, 68, // 1AB -> 2AB
                       68, 68, 68, 67, 59, 59, 59, // view 2AB
                       44, 44, 44, // 2AB -> 3AB
                       44, 44, 44, 44, 44, 44, 44, 44, // view 3AB
                       44, 44, 20, 20, 20, // 3AB -> 4AB
                       20, 20, 20, 20, 23, 31, 31, 31, // view 4AB
                       57, 57, 57, 57, 58, // 4AB -> 5AB
                       66, 66, 66, 66, 66, 66, 66, // view 5AB
                       99, 99, 99, // 5AB -> 6AB
                       99, 99, 99, 99, 99, 99, 99, 99, // view 6AB
                       99, 99, 129, // 6AB -> 7AB
                       137, 137, 147, 147, 147, 147, 147, 147, // view 7AB
                       147, 147, 143, // 7AB -> 8AB
                       135, 135, 135, 123, 123, 123, 123, 123, 123, // view 8AB
                       ...
                       147, 147, 147, 147, 144, 136, 136, 136, 136, // view 11AB
    ...
    private float[] turnDirection =
        new float[] { 360, // direction observation
                      ...
                      -90, 0, 0, 90, 0, 90, 0, 0, -90, // view facades 1AB
                      0, 90, 0, -90, 0, 90, 0, // 1AB -> 2AB
                      90, 0, 0, 0, 90, 0, -90, // view 2AB
                      0, -90, 0, // 2AB -> 3AB
                      90, 0, -90, 0, -90, 0, 0, 90, // view 3AB
                      0, 90, 0, -90, 0, // 3AB -> 4AB
                      -90, 0, 0, 0, 0, -90, 0, 90, // view 4AB
                      0, -90, 0, 90, 0, // 4AB -> 5AB
                      90, 0, -90, 0, -90, 0, 90, // view 5AB
                      0, -90, 0, // 5AB -> 6AB
                      -90, 0, 0, 90, 0, 90, 0, -90, // view 6AB
                      0, 90, 0, // 6AB -> 7AB
                      90, 0, 0, 0, 90, 0, 0, -90, // view 7AB
                      0, 90, 0, // 7AB -> 8AB
                      -90, 0, 0, 0, 0, -90, 0, 0, 90, // view 8AB
                      0, 90, 0, -90, 0, // 8AB -> 9AB
                      -90, 0, 90, 0, 90, 0, 0, -90, // view 9AB
                      0, -90, 0, 90, 0, // 9AB -> 10AB
                      -90, 0, 0, 0, -90, 0, 90, // view 10AB
                      0, -90, 0, // 10AB -> 11AB
                      -90, 0, 0, 0, 0, -90, 0, 0, 90, // view 11AB
                      0, 90, 0, 90, 0, // 11AB -> 12AB
                      -90, 0, 0, 90, 0, 90, 0, -90, // view 12AB
    ...
    private float[] curHeading =
        new float[] { 180, 180, // direction observation
                      ...
                      270, 270, 270, 0, 0, 90, 90, 90, 0, // view facades 1AB
                      0, 90, 90, 0, 0, 90, 90, // 1AB -> 2AB
                      180, 180, 180, 180, 270, 270, 180, // view 2AB
                      180, 90, 90, // 2AB -> 3AB
                      180, 180, 90, 90, 0, 0, 0, 90, // view 3AB 
                      90, 180, 180, 90, 90, // 3AB -> 4AB
                      0, 0, 0, 0, 0, 270, 270, 0, // view 4AB
                      0, 270, 270, 0, 0, // 4AB -> 5AB
                      90, 90, 0, 0, 270, 270, 0, // view 5AB
                      0, 270, 270, // 5AB -> 6AB
                      180, 180, 180, 270, 270, 0, 0, 270, // view 6AB
                      270, 0, 0, // 6AB -> 7AB
                      90, 90, 90, 90, 180, 180, 180, 90, // view 7AB
                      90, 180, 180, // 7AB -> 8AB
                      90, 90, 90, 90, 90, 0, 0, 0, 90, // view 8AB
                      90, 180, 180, 90, 90, // 8AB -> 9AB
                      0, 0, 90, 90, 180, 180, 180, 90, // view 9AB
                      90, 0, 0, 90, 90, // 9AB -> 10AB
                      0, 0, 0, 0, 270, 270, 0, // view 10AB
                      0, 270, 270, // 10AB -> 11AB
                      180, 180, 180, 180, 180, 90, 90, 90, 180, // view 11AB
                      180, 270, 270, 0, 0, // 11AB -> 12AB
                      270, 270, 270, 0, 0, 90, 90, 0, // view 12AB
    ...
    void Update()
    {
        ...
        // {
        //    EventLogger.Instance.LogEvent("Skipped the navigation session 7," + System.DateTime.Now.ToString("yyyyMMdd, HH:mm, ss.ffff,") + "-, -, -, -");
        //    SceneManager.LoadScene(next_scene_name);
        // }
