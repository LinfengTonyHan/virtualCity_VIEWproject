...
public class City_Manager_4 : MonoBehaviour
{
    ...
    private int[] landmarkIndex = { 2, 1, 4, 3 }; // 4 JRD questions in session 4
    private int[] correctJRDanswers = { 3, 3, 4, 1 }; // 4 JRD questions in session 4
    ...
    private bool navEnd;
    private string next_scene_name = "DVIM_City_Main_5"; // Change this in the new version
    ...
    private string[] moveMethods =
        new string[] { "turn", // Make observations of directions at the beginning
                       ...
                       "mZnT", "view", "turn", "stop", "turn", "tJRD", "view", "turn", // View facades 1A & 1B // TEST ON 1B
                       ...
                       "mXnT", "view", "turn", "stop", "turn", "tJRD", "view", "turn", // View facades 3A & 3B // TEST ON 3B
                       ...
                       "mZnT", "tJRD", "view", "mZnV", "mXnV", "mXnT", "view", "turn", // View facades 7A & 7B // TEST ON 7A
                       ...
                       "mXnT", "view", "mXnV", "mZnV", "mZnT", "tJRD", "view", "turn", // View facades 11A & 11B // TEST ON 11B
    ...
    private float[] positionX =
        new float[] { 95, 95, // direction observation
                      ...
                      162, 162, 150, 150, 150, 150, 150, 150, // view 11AB
    ...
    private float[] positionZ =
        new float[]  { 68, 68, // direction observation
                       ...
                       147, 147, 147, 144, 136, 136, 136, 136, // view 11AB
    ...
    private float[] turnDirection =
        new float[] { 360, // direction observation
                      ...
                      -90, 0, 90, 0, 90, 0, 0, -90, // view facades 1AB
    ...
    private float[] curHeading =
        new float[] { 180, 180, // direction observation
                      ...
                      270, 270, 0, 0, 90, 90, 90, 0, // view facades 1AB
                      ...
                      0, 270, 270, // 10AB -> 11AB
                      180, 180, 180, 180, 90, 90, 90, 180, // view 11AB
    ...
    void Update()
    {
        ...
        // {
        //    EventLogger.Instance.LogEvent("Skipped the navigation session 4," + System.DateTime.Now.ToString("yyyyMMdd, HH:mm, ss.ffff,") + "-, -, -, -");
        //    SceneManager.LoadScene(next_scene_name);
        // }
