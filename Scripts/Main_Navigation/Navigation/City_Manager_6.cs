...
public class City_Manager_6 : MonoBehaviour
{
    ...
    private int[] idnChoiceList1 = { 4, 7, 15, 13, 1, 8 }; // 6 questions in session 6
    private int[] idnChoiceList2 = { 2, 24, 12, 16, 10, 20 };
    private int[] idnChoiceList3 = { 3, 5, 21, 18, 19, 6 };
    private int[] correctIDNanswers = { 3, 3, 2, 1, 3, 2 };
    ...
    private int[] landmarkIndex = { 4, 3, 2, 1, 3, 4 }; // 6 questions in session 6
    private int[] correctJRDanswers = { 3, 2, 3, 1, 4, 4 }; // 6 questions in session 6
    ...
    private bool navEnd;
    private string next_scene_name = "DVIM_JRD_2"; // Change this in the new version: Go to the JRD task
    ...
    private string[] moveMethods =
        new string[] { "turn", // Make observations of directions at the beginning
                       ...
                       "mXnT", "tIDN", "view", "mXnV", "mZnV", "mZnT", "tJRD", "view", "turn", // View facades 2A & 2B // IDN TEST ON 2A, JRD TEST ON 2B
                       "movZ", "turn", "movX", // From facades 2A & 2B to facades 3A & 3B
                       "mXnT", "tIDN", "view", "turn", "stop", "turn", "view", "turn", // View facades 3A & 3B // IDN TEST ON 3A
                       "movX", "turn", "movZ", "turn", "movX", // From facades 3A & 3B to facades 4A & 4B
                       "mXnT", "view", "mXnV", "mZnV", "mZnT", "tJRD", "view", "turn", // View facades 4A & 4B // JRD TEST ON 4B
                       "movZ", "turn", "movX", "turn", "movZ", // From facades 4A & 4B to facades 5A & 5B
                       "mZnT", "tJRD", "view", "turn", "stop", "turn", "tJRD", "view", "turn", // View facades 5A & 5B // JRD TEST ON 5A & 5B
                       "movZ", "turn", "movX", // From facades 5A & 5B to facades 6A & 6B
                       "mXnT", "view", "turn", "stop", "turn", "tIDN", "view", "turn", // View facades 6A & 6B // IDN TEST ON 6B
                       "movX", "turn", "movZ", // From facades 6A & 6B to facades 7A & 7B
                       "mZnT", "tIDN", "view", "mZnV", "mXnV", "mXnT", "view", "turn", // View facades 7A & 7B // IDN TEST ON 7A
                       ...
                       "mXnT", "tJRD", "view", "turn", "stop", "turn", "view", "turn", // View facades 9A & 9B // JRD TEST ON 9A
                       "movX", "turn", "movZ", "turn", "movX", // From facades 9A & 9B to facades 10A & 10B 
                       "mXnT", "tIDN", "view", "mXnV", "mZnV", "mZnT", "tIDN", "view", "turn", // View facades 10A & 10B // IDN TEST ON 10A & 10B
                       ...
                       "mZnT", "view", "turn", "stop", "turn", "tJRD", "view", "turn", // View facades 12A & 12B // JRD TEST ON 12B
    ...
    private float[] turnDirection =
        new float[] { 360, // direction observation
                      ...
                      90, 0, 0, 0, 0, 90, 0, 0, -90, // view 2AB
                      0, -90, 0, // 2AB -> 3AB
                      90, 0, 0, -90, 0, -90, 0, 90, // view 3AB
                      0, 90, 0, -90, 0, // 3AB -> 4AB
                      -90, 0, 0, 0, -90, 0, 0, 90, // view 4AB
                      0, -90, 0, 90, 0, // 4AB -> 5AB
                      90, 0, 0, -90, 0, -90, 0, 0, 90, // view 5AB
                      0, -90, 0, // 5AB -> 6AB
                      -90, 0, 90, 0, 90, 0, 0, -90, // view 6AB
                      0, 90, 0, // 6AB -> 7AB
                      90, 0, 0, 0, 0, 90, 0, -90, // view 7AB
                      0, 90, 0, // 7AB -> 8AB
                      -90, 0, 0, 0, -90, 0, 90, // view 8AB
                      0, 90, 0, -90, 0, // 8AB -> 9AB
                      -90, 0, 0, 90, 0, 90, 0, -90, // view 9AB
                      0, -90, 0, 90, 0, // 9AB -> 10AB
                      -90, 0, 0, 0, 0, -90, 0, 0, 90, // view 10AB
                      0, -90, 0, // 10AB -> 11AB
    ...
    private float[] curHeading =
        new float[] { 180, 180, // direction observation
                      ...
                      180, 180, 180, 180, 180, 270, 270, 270, 180, // view 2AB
                      180, 90, 90, // 2AB -> 3AB
                      180, 180, 180, 90, 90, 0, 0, 90, // view 3AB 
                      90, 180, 180, 90, 90, // 3AB -> 4AB
                      0, 0, 0, 0, 270, 270, 270, 0, // view 4AB
                      0, 270, 270, 0, 0, // 4AB -> 5AB
                      90, 90, 90, 0, 0, 270, 270, 270, 0, // view 5AB
                      0, 270, 270, // 5AB -> 6AB
                      180, 180, 270, 270, 0, 0, 0, 270, // view 6AB
                      270, 0, 0, // 6AB -> 7AB
                      90, 90, 90, 90, 90, 180, 180, 90, // view 7AB
                      90, 180, 180, // 7AB -> 8AB
                      90, 90, 90, 90, 0, 0, 90, // view 8AB
                      90, 180, 180, 90, 90, // 8AB -> 9AB
                      0, 0, 0, 90, 90, 180, 180, 90, // view 9AB
                      90, 0, 0, 90, 90, // 9AB -> 10AB
                      0, 0, 0, 0, 0, 270, 270, 270, 0, // view 10AB
                      0, 270, 270, // 10AB -> 11AB
    ...
    void Update()
    {
        ...
        // {
        //    EventLogger.Instance.LogEvent("Skipped the navigation session 6," + System.DateTime.Now.ToString("yyyyMMdd, HH:mm, ss.ffff,") + "-, -, -, -");
        //    SceneManager.LoadScene(next_scene_name);
        // }
