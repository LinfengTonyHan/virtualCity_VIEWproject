...
public class JRD_2 : MonoBehaviour
{
    ...
    // private int[] facade_ID = { 2, 20, 17, 6, 7, 4, 24, 13, 5, 3, 14, 22, 23, 8, 11, 18, 15, 21, 19, 16, 10, 12, 9, 1 }; // In this specific randomization, the 24 facades were organized in this order in the city
    ...
    private int[] JRD_Target_ID = { 8, 16, 10, 11, 6, 21, 9, 14, 18, 4, 17, 23, 22, 24, 5, 1, 13, 7, 3, 2, 19, 20, 12, 15 }; // a random trial sequence (see stored file)

    private int[] landmark_ID = { 3, 2, 1, 2, 4, 4, 2, 2, 3, 2, 4, 3, 4, 3, 1, 4, 4, 1, 1, 2, 3, 1, 3, 1 }; // a random trial sequence (see stored file)
    ...
    private string next_scene_name = "DVIM_City_Main_7";
